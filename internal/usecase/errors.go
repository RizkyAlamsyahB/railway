...
var (
	...
	ErrGoogleOAuthDisabled       = errors.New("google oauth login is not configured")
	ErrGoogleIDTokenInvalid      = errors.New("invalid google id token")
	ErrGoogleEmailNotVerified    = errors.New("google account email is not verified")
	ErrGoogleAccountNotCustomer  = errors.New("google account is not allowed for this endpoint")
...
var (
	...
	ErrVendorBankNotOwned          = errors.New("bank account does not belong to this vendor")
